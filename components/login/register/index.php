<section>
  <form action="/components/<?php echo $_GET['p'];?>/register.php" method="post" class="form-horizontal">
    <h3>Register</h3>
    ...
    <div class="form-group">
      <label for="year" class="col-sm-2 control-label">Birthday</label>
      <div class="col-sm-10">
        <input type="date" name="birthday" class="form-control" value="<?php echo $_SESSION['post']['birthday'];?>" ></input>
      </div>
    </div>
