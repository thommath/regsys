...
require_once("dependencies/php/login.php");
  ...
  if(!isset($_POST['name']) || !isset($_POST['id'])){
      ...
      $_SESSION['from'] = 'editCategory';
      $_SESSION['success'] = false;
      $_SESSION['error'] = $errorList;
      $_SESSION['post'] = $_POST;
      header("Location: http://" . $_SERVER['SERVER_NAME'] . "/category/editCategory.php", true);
      die();
  }else{
    ...
    $accepted = $conn->query("UPDATE `Category` SET `name`='" . $_POST['name'] . "', `description`='" . $_POST['description'] . "' WHERE `user`=" . $_SESSION['user'] . " AND `id`=" . $_POST['id']);
